...
defineModuleConfig('server', {
  name: {
    desc: 'A recognizable name for the server. Will be shown when connected with Voxa Portal Desktop.',
    default: undefined,
    shape: z.string().optional(),
  },
  externalUrl: {
    desc: `Base url of Voxa Portal server, used for generating external urls.
