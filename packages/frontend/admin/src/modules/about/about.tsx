...
const appNames = {
  stable: 'Voxa Portal',
  canary: 'Voxa Portal Canary',
  beta: 'Voxa Portal Beta',
  internal: 'Voxa Portal Internal',
...
const links = [
  {
    ...
    label: 'Star Voxa Portal on GitHub',
  },
  {
    href: BUILD_CONFIG.githubUrl,
  ...
  return (
    <div className="flex flex-col h-full gap-3 py-5 px-6 w-full">
      <div className="flex items-center">
        <span className="text-xl font-semibold">About Voxa Portal</span>
      </div>
